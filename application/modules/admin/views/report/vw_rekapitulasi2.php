...
<main>
     ...
     <div class="left">
		 <h2>Approve By:</h2><h3>SPV.Cashier</h3>
		<hr>
	  </div> 
      <div class="right">
		 <h2>Create By:</h2><h3>Cashier</h3>
